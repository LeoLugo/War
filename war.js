...
export class Player {
  ...
  get handhtml() {
    return this._hand.map(card => `
      <div class="card">
        <div class="back">X</div>
        <div class="front ${card.suit}">
...
export class War {
  ...
  turn(cards = []) {
    ...
    this.player1div.append(`<div class="card">
        <div class="back">X</div>
        <div class="front ${card1.suit}">
          ${card1.display}&${card1.suit};
        </div>
      </div>`)
    this.player2div.append(`<div class="card">
        <div class="back">X</div>
        <div class="front ${card2.suit}">
          ${card2.display}&${card2.suit};
        </div>
      </div>`)

    setTimeout(()=>{

      this.player1div.find('.card:last-child').delay(500).toggleClass('flip')
      this.player2div.find('.card:last-child').delay(500).toggleClass('flip')  
    }, 0)
